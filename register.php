                        ...
                        <form id="register-form" novalidate>
                            <div class="row"> 
                                ...
                                <div class="formm-check mb-3">
                                    ...
                                    <input type="radio" class="formm-check-input" name="gender" value="Male">
                                    <label class="form-check-label" for="Male">Male</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" class="formm-check-input" name="gender" value="Female">
                                    <label class="form-check-label" for="Female">Female</label>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" class="formm-check-input" name="gender" value="Others">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php 
                                        ...
                                        while ($Row = mysqli_fetch_array($GetQualifications)) {
                                            ...
                                            echo '<input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="checkbox[]" value="'.$Row['QualificationId'].'">';
                                            echo '<label class="form-check-label" for="inlineCheckbox1">'.$Row['QualificationName'].'</label>';
                                            echo '</div>';
                                        }
                                    ?>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control form-select" id="state" name="state">
                                        ...
                                        <?php $GetState= mysqli_query($con, "SELECT * FROM  state"); 
                                            while ($StateRow=mysqli_fetch_array($GetState)) {
                                               ?>
                                               <option value="<?php echo $StateRow['StateId'];?>"> <?php echo $StateRow['State']; ?></option> 
                                               <?php
                                            }
                                            ?>
                                    </select>
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <select class="form-control form-select" id="district" name="district">
                                        <option selected value=" " disabled="disabled">Select District</option>
